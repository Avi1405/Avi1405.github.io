...
projectsSection.innerHTML = `
  ...
  <div class="projects-content">
    <div class="section-heading reveal">
      ...
      <h2>Ideas made tangible.<br><em>Systems made useful.</em></h2>
    </div>
    <div class="project-grid">
      <a class="project-card project-card-featured reveal"
        href="https://github.com/Avi1405/distributed-task-queue"
        ...
        <div>
          ...
          <p>A Redis-backed Spring Boot service with delayed priority scheduling, atomic Lua claims, exponential retries, dead-letter handling, Prometheus metrics, Docker, and CI.</p>
        </div>
        <div class="project-stack"><span>Java 17</span><span>Spring Boot</span><span>Redis</span><span>Docker</span></div>
      </a>
      <a class="project-card reveal delay-1"
        href="https://github.com/Avi1405/mygptapp"
        target="_blank" rel="noreferrer">
        ...
        <div>
          ...
          <p>An SEO-first schedule experience covering 104 matches with local-time conversion, country filtering, fallback data, and SportsEvent structured metadata.</p>
        </div>
        <div class="project-stack"><span>JavaScript</span><span>HTML/CSS</span><span>JSON-LD</span><span>Responsive UI</span></div>
      </a>
      <a class="project-card project-card-wide reveal delay-2"
        href="https://github.com/Avi1405/IPL"
        target="_blank" rel="noreferrer">
        <div class="project-top"><span>Full-stack data product</span><span aria-hidden="true">↗</span></div>
        <div>
          <p class="project-number">03</p>
          <h3>IPL Dashboard</h3>
          <p>A full-stack cricket analytics dashboard that imports 816 historical matches with Spring Batch and exposes team records, recent results, win ratios, and season views through a React interface.</p>
        </div>
        <div class="project-stack"><span>Java</span><span>Spring Batch</span><span>JPA</span><span>React</span><span>REST API</span></div>
      </a>
    </div>
  </div>`;
